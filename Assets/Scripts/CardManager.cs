...
public static class CardManager
{
    ...
    public static void Init()
    {
        ...
        cards.Add(new Card(7, 7, CardType.HELPER, CardSubType.NONE, false));
        cards.Add(new Card(8, 8, CardType.HELPER, CardSubType.NONE, false));
        cards.Add(new Card(9, 9, CardType.HELPER, CardSubType.NONE, false));
